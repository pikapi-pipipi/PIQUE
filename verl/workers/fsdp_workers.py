...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    async def rollout_mode(self):
        ...
        if peft_config is not None and self.base_sync_done:
            ...
            per_tensor_param = (
                (name, dtensor_to_full_tensor(param, device) if isinstance(param, DTensor) else param)
        ...
        if (
            ...
            per_tensor_base_params = (
                (name, dtensor_to_full_tensor(param, get_device_id()) if isinstance(param, DTensor) else param)
